...
for (i in 1:100) {
  ...
  result <- ACS_Alg_O(obs_gen_para, kei = 4, lambda)
...
saveRDS(results_200, file.path(output_dir, "data_50_4_3.rds"))
...
saveRDS(results_225, file.path(output_dir, "data_50_4_4.rds"))
...
results <- rbind(results_200, results_225)
